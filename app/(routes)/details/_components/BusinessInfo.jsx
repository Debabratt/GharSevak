...
import { Clock, DollarSign, Mail, MapPin, Share, User } from 'lucide-react'
...
function BusinessInfo({business}) {
  return business?.name&&(
    <div className='md:flex gap-4 items-center'>
      ...
      <Button>
      <h2 className='flex gap-2 text-lg text-gray-500 rounded-xl'>
      
       From {business?.contactPerson}</h2>
        </Button>
      </div>
